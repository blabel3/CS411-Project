...
export async function create<Type extends IDatabaseObject>(
  obj: Type
): Promise<Type> {
  await setupDB();
...
export async function read<Type extends IDatabaseObject>(
  id: string
): Promise<Type> {
  await setupDB();
...
export async function update<Type extends IDatabaseObject>(
  obj: Type
): Promise<Type> {
