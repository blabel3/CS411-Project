...
const searchTermsMap = {
  ...
  instrumentalness: {
    high: ["instrument", "instrumental"],
    low: ["vocal", "voice", "rap"],
    threshold: 0.5,
  },
  liveness: { high: ["audience", "concert"], low: [""], threshold: 0.5 },
  valence: {
    high: ["happy", "cheerful", "euphoric"],
    low: ["sad", "depressed", "angry"],
    threshold: 0.5,
  },
...
export async function getPhotoForPlaylist(
  audioFeatures: IPlaylistFeatures
): Promise<string> {
